...
clean_na <- function(x) {ifelse(is.na(x) | x == "NA", "  ", x)} #función para limpiar NAs
habitat_html <- glue("
<table style='width:100%; border-collapse: collapse; table-layout: fixed;'>
  <tr style='text-align:center;'>
    <td style='border:1px solid #D9D9D9; padding:4px;'>{clean_na(params$puntos$HabitatGeneral)}</td>
...
\* Ver <a href="https://atlasaves.seo.org/wp-content/uploads/2021/12/Anexo-3-ficha-habitat-atlas-rep-2014_17.pdf" target="_blank">ficha de hábitats de SEO/BirdLife</a>
...
row.names(info_grabt) <- c("ID de la grabadora","Esquema de grabación","Ganancia","Frecuencia de muestreo","Periodo de grabación en el punto","Minutos grabados","Sesiones con datos incompletos", "Archivos generados","Tarjeta de memoria", "Baterías")
